      ...
      <ReferralModal isOpen={showModal} maxHeight={750} maxWidth={800} $scrollOverlay={true} onDismiss={handleCloseModal}>
        <ModalWrapper>
          <ModalHeader>
            ...
            <ThemedText.SubHeader color='accentActive'>LIMITLESS</ThemedText.SubHeader>
          </ModalHeader>
          <ActionsWrapper>
            <Actions active={!walletConnected}>
              <Status><ThemedText.BodySmall fontWeight={800}> {!walletConnected ? '1': '✓'}</ThemedText.BodySmall></Status>
              {!walletConnected ? (
