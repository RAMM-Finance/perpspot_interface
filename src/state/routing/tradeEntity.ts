...
import { IRoute, RouteV2, RouteV3 } from './routes'
...
export class SwapTrade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
  ...
  public static async fromRoutes<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(
    ...
    tradeType: TTradeType
  ): Promise<SwapTrade<TInput, TOutput, TTradeType>> {
