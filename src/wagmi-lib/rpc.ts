...
// export function getProvider(signer: undefined, chainId: number): JsonRpcProvider
// export function getProvider(signer: Signer, chainId: number): Signer
// export function getProvider(signer: Signer | undefined, chainId: number): JsonRpcProvider | Signer
// export function getProvider(signer: Signer | undefined, chainId: number): JsonRpcProvider | Signer {
//   let url
...
//   return new JsonRpcProvider(url, chainId, { staticNetwork: network })
// }
...
//   if (chainId === ARBITRUM) {
//     return new WebSocketProvider(getAlchemyWsUrl(), network, { staticNetwork: network })
//   }

//   if (chainId === AVALANCHE) {
//     return new WebSocketProvider('wss://api.avax.network/ext/bc/C/ws', network, { staticNetwork: network })
//   }

//   if (chainId === ARBITRUM_GOERLI) {
//     return new WebSocketProvider('wss://arb-goerli.g.alchemy.com/v2/cZfd99JyN42V9Clbs_gOvA3GSBZH1-1j', network, {
//       staticNetwork: network,
//     })
//   }

//   if (chainId === AVALANCHE_FUJI) {
//     const provider = new JsonRpcProvider(getRpcUrl(AVALANCHE_FUJI), network, { staticNetwork: network })
