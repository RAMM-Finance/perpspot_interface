...
const ZapInputPanel = styled.div<{ hideInput?: boolean }>`
  ${flexColumnNoWrap};
  position: relative;
  border-radius: ${({ hideInput }) => (hideInput ? '16px' : '20px')};
  z-index: 1;
...
interface ZapTokenPanelProps {
  ...
  loading?: boolean
  label?: string
  onInputTokenChange?: (inputCurrency: Currency) => void
}

export function ZapTokenPanel({
  value,
  onUserInput,
  onMax,
  showMaxButton,
