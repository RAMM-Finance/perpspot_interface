...
export const Brush = ({
  ...
  setBrushExtent: ((domain: [number, number], mode: string | undefined) => void) | undefined
  innerWidth: number
  innerHeight: number
  ...
  const [localBrushExtent, setLocalBrushExtent] = useState<[number, number] | null>(brushExtent ? brushExtent : null)
  ...
  const brushed = useCallback(
    (event: D3BrushEvent<unknown>) => {
      ...
      if (!brushExtent || !setBrushExtent) return
              ...
              >
                ...
                >
                  ...
                  <Tooltip transform="scale(-1, 1)" y="15" dominantBaseline="middle">
                    {brushLabelValue && brushLabelValue('w', localBrushExtent[0])}
                  </Tooltip>
                </LabelGroup>
              </g>
            ) : null}
              ...
              <g transform={`translate(${xScale(localBrushExtent[1])}, 0), scale(${flipEastHandle ? '-1' : '1'}, 1)`}>
                ...
                >
                  ...
                  <Tooltip y="15" dominantBaseline="middle">
                    {brushLabelValue && brushLabelValue('e', localBrushExtent[1])}
                  </Tooltip>
                </LabelGroup>
              </g>
            ) : null}
