...
const strikes: PricesMap = {
  // eth-usdc
  '0xd0b53d9277642d899df5c87a3966a349a798f224': [800, 500, 100000000000000000, 0], // tickoter, innter, util, threshold

  // degen
  '0xc9034c3e7f58003e6ae0c8438e7c8f4598d5acaa': [4500, 3900, 50000000000000000, 0],

  // brett
  '0xba3f945812a83471d709bce9c3ca699a19fb46f7': [4500, 3500, 0, 0],

  // toshi
  '0x4b0aaf3ebb163dd45f663b38b6d93f6093ebc2d3': [4500, 3500, 20000000000000000, 0],

  // aero
  '0x3d5d143381916280ff91407febeb52f2b60f33cf': [4500, 3500, 50000000000000000, 0],

  // okayeg
  '0x58342c302dd4df0531f60dd3c0eabb0c95ac08cb': [4500, 3500, 50000000000000000, 0],

  // spec
  '0x8055e6de251e414e8393b20adab096afb3cf8399': [4500, 3500, 50000000000000000, 0],

  // build
  '0x0f082a7870908f8cebbb2cd27a42a9225c19f898': [4500, 3500, 10000000000000000, 0],

  // higher
  '0xcc28456d4ff980cee3457ca809a257e52cd9cdb0': [4500, 3500, 10000000000000000, 0],
}
