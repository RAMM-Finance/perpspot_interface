...
const strikes: PricesMap = {
  ...
  // brett
  '0xba3f945812a83471d709bce9c3ca699a19fb46f7': [4500, 3500, 100000000000000000, 1000],

  // toshi
  '0x4b0aaf3ebb163dd45f663b38b6d93f6093ebc2d3': [4500, 3500, 100000000000000000, 1000],
